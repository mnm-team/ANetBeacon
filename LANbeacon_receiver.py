...
#  lldp_rawsocket.getLLDP
  ...
  ### Get information that is not stored as cleartext in LLDP packet
  ...
  inhalteZumAusgeben = stringLLDPcontent.split(". ")    # Rest of split up raw string
  inhalteZumAusgeben[0] = "VLANname: " + VLANname
  inhalteZumAusgeben.insert(1,"VLANid: " + str(VLANid))

  #debugprint print("hexLLDPcontent: " + hexLLDPcontent)
  print("stringLLDPcontent: " + stringLLDPcontent)
  #debugprint print(inhalteZumAusgeben)
  #debugprint print("1111111111222222222233333333334444444444")

  ###  Split up text lines so that they fit on C-Berry screen, format outputs so that information is alligned
